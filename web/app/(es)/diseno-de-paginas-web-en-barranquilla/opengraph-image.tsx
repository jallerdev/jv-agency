...
/**
 * La tarjeta social de Barranquilla.
 *
 * EL TITULAR VA ENTERO, con la segunda línea y todo: «sin oficina en Barranquilla» es lo único
...
const tarjeta = tarjetaOg({
  ...
  titulo: "Diseño de páginas web en Barranquilla, sin oficina en Barranquilla",
  precio: "landing",
});
