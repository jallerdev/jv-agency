...
export const metadata: Metadata = {
  ...
  description:
    "I build your online store with catalogue, inventory, cart, payments via PSE, Nequi and card, and quoted shipping. From $2,500,000 COP, ready in 3 to 5 weeks.",
  alternates: {
  ...
  openGraph: {
    title: "Online store development in Colombia | JV Agencia",
    description:
      "Your store charges on its own: PSE, Nequi and card, inventory and shipping. From $2,500,000 COP, ready in 3 to 5 weeks.",
